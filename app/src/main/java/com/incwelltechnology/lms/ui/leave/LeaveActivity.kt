...
class LeaveActivity : BaseActivity<ActivityLeaveBinding>(), DatePickerDialog.OnDateSetListener, LeaveListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        leaveViewModel.leaveListener=this
