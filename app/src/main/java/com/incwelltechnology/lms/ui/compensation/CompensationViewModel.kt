...
class CompensationViewModel(private val compensationRepository: CompensationRepository):ViewModel() {
    ...
    fun onApplyCompensationButtonClick(){
        Coroutine.io {
            val compensationResponse=compensationRepository.createCompensation(days!!,compensationReason!!)
